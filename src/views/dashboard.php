    ...
    <div class="flex">
        ...
        <main id="main-content" class="flex-1 p-6 overflow-x-auto">
            ...
            if ($view) {
                ...
                require_once __DIR__ . '/../partials/dashboard_pages/admin/functions/func_users.php';
                require_once __DIR__ . '/../partials/dashboard_pages/admin/functions/func_schedules.php';
                require_once __DIR__ . '/../partials/dashboard_pages/admin/functions/func_programs.php';
                require_once __DIR__ . '/../partials/dashboard_pages/admin/functions/func_curriculums.php';
                require_once __DIR__ . '/../partials/dashboard_pages/admin/functions/func_rooms.php';
